...
<pre>git clone https://github.com/cerebrumlab/Starthtml</pre>

<ol>
	<li>Clone or <a href="https://github.com/cerebrumlab/Starthtml/archive/master.zip">Download</a> <strong>OptimizedHTML 5</strong> from GitHub</li>
